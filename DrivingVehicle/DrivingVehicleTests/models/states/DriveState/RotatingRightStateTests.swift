...
class VehicleMock5:  VehicleTemplate{
...
class RotatingRightStateTests: XCTestCase {
    ...
    override func setUp() {
        ...
        _vehicleStatusManager.setState(RotatingRightState())
    ...
    func testOnForward() {
        ...
        _mock = VehicleMock5(exception: _exception)
